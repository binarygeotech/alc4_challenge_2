            ...
            Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(getBaseContext(), "Image upload completed", Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(getBaseContext(), "Image upload failed!", Toast.LENGTH_LONG).show();
                    }
                }
...
//                    Log.d("Deal Image", "Image Delete Successful");
                }
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
//                    Log.d("Deal Image", "Image Delete failed");
                }
            });
        }
    }
